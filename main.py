...
#---------MODIF--------------
@socketio.on('classification_update')
def classification_update(classification):
    """Changes the classification of the pictures"""
    print(classification)
    ironcar.select_classification(classification)
